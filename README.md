...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ecnjg8m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ecnjg8m.containers.anotherwebservice.com/
...
```
git clone git@github.com:Kavindu-Deshapriya/container-ecnjg8m.git
cd container-ecnjg8m
```
...
```
docker attach container-ecnjg8m
```
